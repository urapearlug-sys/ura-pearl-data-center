        ...
        <div className="flex-1 overflow-y-auto min-h-0 px-4 py-4">
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-5 text-gray-300 text-sm space-y-1 mb-2">
              ...
              <li><strong className="text-white">Tasks:</strong> Team vs Team challenges – available (pending/active) and completed. See target ALM, prize pool, and status.</li>
            </ul>
            <p className="text-gray-300 text-sm leading-relaxed">
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-5 text-gray-300 text-sm space-y-1 mb-2">
              <li><strong className="text-white">Create team:</strong> Tap <strong className="text-white">Create team</strong>, enter a team name, and pay the <strong className="text-white">1,000,000 ALM</strong> commitment (team is lower rank than league). You get a team invite code; share it so others can join your team.</li>
              ...
              <li><strong className="text-white">Create league:</strong> Only <strong className="text-white">teams</strong> can create leagues (10,000,000 ALM). Tap <strong className="text-white">Create league</strong>, pick your team, enter a league name, and pay. Your team is the first team in the league. You get a league code to share so <strong className="text-white">other teams</strong> can join.</li>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-5 text-gray-300 text-sm space-y-1 mb-2">
              ...
              <li><strong className="text-white">Contribute:</strong> During an active challenge, anyone can add ALM to the prize pool; minimum contribution applies.</li>
            </ul>
            <p className="text-gray-300 text-sm leading-relaxed">
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-5 text-gray-300 text-sm space-y-1 mb-2">
              ...
              <li><strong className="text-white">Reward distribution:</strong> The <strong className="text-white">creator who paid the stake</strong> for the winning team gets their stake back from the prize pool first. The remainder is shared in proportion to each member’s ALM growth (or equally if no one had growth)—so the stake-payer is rewarded and the rest of the team shares the rest.</li>
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Higher tiers unlock better rewards (ALM, badges, and later things like whitelist access or exclusive airdrops). Legend tier gets the biggest rewards and public recognition. Rewards are distributed at the end of each week and at Championship events. Stay active, earn LP, and climb the tiers to get the best rewards.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-5 text-gray-300 text-sm space-y-1">
              ...
              <li><strong className="text-white">Team</strong> = 1M ALM (lower rank), <strong className="text-white">League</strong> = 10M ALM. Only teams create and join leagues; no single user joins a league. Earn <strong className="text-sky-300">TP</strong> in a team, <strong className="text-[#f3ba2f]">TP + LP</strong> in a league (2× LP).</li>
              <li>Use <strong className="text-white">League Competition</strong> to see teams competing and challenge another league: stake ALM, first to target (or highest at the end) wins; leagues can be in multiple challenges if they meet each challenge’s requirements; anyone can contribute to the prize pool.</li>
              ...
              <li><strong className="text-white">Joinable tasks</strong>: browse global competitions (team or league), invite an opponent, stake ALM; when they accept the competition starts (snapshots, time limit). First to reach target wins; management adds 30% to the prize pool.</li>
            </ul>
          </section>
        </div>
      </div>
