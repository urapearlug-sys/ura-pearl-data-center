...
const AdminPanel = () => {
    ...
    const earnScreenSections = [
        {
            title: 'Manage Tasks (Earn Activities)',
            path: '/admin/tasks',
            description: 'Add, edit, and manage task activities shown in the Earn tab task list (tabbed by category)',
        },
        {
            title: 'Published activities feed',
            path: '/admin/published-activities',
            description: 'Short posts under “Activities” on the Earn tab — newest published items appear on top in the app',
        },
    ];
    ...
    const adminSections = [
        ...
        { title: 'URA Quiz', path: '/admin/quiz', description: 'Multiple-choice URA Quiz on Earn: manage questions, pool, completion bonus, and Mon/Thu UTC automated sets' },
        ...
        <div className="min-h-screen bg-ura-panel text-white p-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-3 mt-10">
                    <h2 className="text-xl font-semibold text-white">Earn screen</h2>
                    <p className="text-sm text-gray-400 mt-1">
                        Manage Tasks lists PEARLS tasks in the app; Published activities are posts under Activities (newest first).
                    </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
