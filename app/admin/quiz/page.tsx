...
const PRESET_BRANCHES = ['General', 'Technical', 'DeFi', 'NFTs', 'Security', 'Bitcoin', 'Ethereum', 'Smart Contracts'] as const;
  ...
  return (
    <div className="min-h-screen bg-[#1d2025] text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-[#f3ba2f] mb-2">Mitroplus Quiz</h1>
        <p className="text-gray-400 mb-6">Branches group questions. Set points per question and a completion bonus when all answers are correct.</p>
        ...
        <div className="bg-[#272a2f] p-6 rounded-xl mb-6">
          <h2 className="text-lg font-semibold mb-2">Blockchain question pool</h2>
          <p className="text-sm text-gray-400 mb-3">Load ~100 blockchain/crypto questions, then set 5 random as daily. You can override by editing which questions are active.</p>
