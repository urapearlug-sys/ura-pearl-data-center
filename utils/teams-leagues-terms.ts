/**
 * Teams & Leagues: operational summary and terms & conditions.
 * Used for display and for requiring agreement when creating/joining.
 */
...
— Joinable tasks (global competitions) —
• Team and league competitions (e.g. first to X taps, referrals, or tier) are browseable. One side invites another; when the opponent accepts and stakes, the race starts. Prizes and rules are set per competition; management may take a share of the pool.`;

/** Full terms and conditions governing teams and leagues (copyable). */
export const TEAMS_LEAGUES_TERMS = `TEAMS AND LEAGUES – TERMS AND CONDITIONS

1. Acceptance
By creating a team or league, or by requesting or completing join to a team or league, you agree to these Terms and to the platform’s general terms and rules.
...
• You may join only one team at a time. Joining another team (by invite code or approved request) removes you from any previous team.
• Join requests are subject to approval by the team creator or league creator. Approval is at their sole discretion. Denial may be with or without reason.

5. Conduct and removal
• You must comply with the platform’s rules and applicable law. The platform may suspend or remove your access to teams/leagues, or remove a team or league, for abuse, fraud, or policy violations.
• Team and league creators may remove members in line with in-app functionality. The platform is not responsible for disputes between users or between creators and members.

6. Challenges and competitions
• Team-vs-team and league-vs-league challenges, and global joinable tasks, have their own rules (stakes, duration, prizes). By participating you accept those rules. Stakes may be non-refundable once a challenge starts. The platform may designate how prizes are split (e.g. league winner among teams) and is not liable for technical or operational issues affecting outcomes.

7. No guarantees
• The platform does not guarantee availability, accuracy of points or rankings, or continuity of any team or league. Data may be corrected or reset as needed for fair operation.

8. Changes
• These terms may be updated. Continued use of teams/leagues after changes constitutes acceptance. For material changes we will use reasonable means to notify users (e.g. in-app notice or link to terms).`;

/** Checkbox label for creator agreement (create team / create league). */
export const TERMS_AGREEMENT_LABEL_CREATOR = 'I agree to the Teams & Leagues Terms and Conditions';

/** Checkbox label for member agreement (request to join team / league). */
export const TERMS_AGREEMENT_LABEL_MEMBER = 'I agree to the Teams & Leagues Terms and Conditions';
