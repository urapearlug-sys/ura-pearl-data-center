...
export const AFROLUMENS_MINI_GAMES: AfrolumensGameDef[] = [
  {
    ...
    intro: {
      ...
      concept: 'Quick taps in a short window to earn ALM.',
      gameplay: 'Tap the target number of times within the time limit. Multiple attempts per day.',
      rewardLogic: 'Success = fixed ALM reward. Daily attempt cap applies.',
  ...
  },
  {
    ...
    intro: {
      ...
      concept: 'Spin the wheel once per day for a random ALM reward.',
  ...
  },
  {
    ...
    intro: {
      ...
      rewardLogic: 'Randomized spawn. Score tied to skill. Max 5 sessions per day. 80 ALM/point, cap 40k.',
  ...
  },
  {
    ...
    intro: {
      ...
      rewardLogic: 'Correct answers = ALM. Low inflation. Easy retention mechanic.',
  ...
  },
  {
    ...
    intro: {
      ...
      rewardLogic: 'Profit % from trades determines ALM reward. Perfect for economy-based boosts.',
